namespace Photoparallel.Web.Components
{
    ...
    public class ConfirmRentComponent : ViewComponent
    {
        private readonly IRentsService rentsService;
        private readonly IMapper mapper;

        public ConfirmRentComponent(IRentsService rentsService, IMapper mapper)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            rentViewModel.Days = (int)(openRent.ReturnDate - openRent.RentDate).TotalDays;
